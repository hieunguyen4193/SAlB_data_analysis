...
if (file.exists(file.path(path.to.04.output, "monocle.obj_graph_test_res.rds")) == FALSE){
  monocle.obj_graph_test_res <- graph_test(monocle.obj, neighbor_graph="principal_graph", cores=16)
  saveRDS(monocle.obj_graph_test_res, file.path(path.to.04.output, "monocle.obj_graph_test_res.rds"))
} else {
  monocle.obj_graph_test_res <- readRDS(file.path(path.to.04.output, "monocle.obj_graph_test_res.rds"))
}
...
#                               plot = TRUE,
#                               parallel = FALSE)
# saveRDS(eval_to_choose_K, file.path(path.to.04.output, "eval_to_choose_K.rds"))
