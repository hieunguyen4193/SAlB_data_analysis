...
# Pseudotime (starting from chosen principal point Y_21)
...
##### Test within lineage
#####----------------------------------------------------------------------#####
if (file.exists(file.path(path.to.09.output, "tradeseq_test_res.rds")) == FALSE){
  ...
  saveRDS(tradeseq.testres, file.path(path.to.09.output, "tradeseq_test_res.rds"))
} else {
  tradeseq.testres <- readRDS(file.path(path.to.09.output, "tradeseq_test_res.rds"))
}
